...
const Navbar = () => {
  return (
    <div className="w-full h-24 flex justify-between fixed ">
      ...
      <div className="flex w-[350px] items-center m-[20px] justify-between items-center content-center">
        ...
        <button className="bg-white w-28 h-9 text-black rounded-md text-md font-semibold">
          Help
        </button>
      </div>
    </div>
