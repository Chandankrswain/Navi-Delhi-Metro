...
const Navbar = () => {
  return (
    <div className="w-screen h-[8rem] flex sm:flex-row justify-center items-center fixed sm:bg-transparent">
      <div className="flex justify-between w-full sm:w-9/12 max-h-[6rem] items-center p-4 sm:p-0">
        ...
        <div>
          <button className="w-32 sm:w-40 h-12 sm:h-14 text-white text-sm sm:text-md border font-['Share_Tech_Mono'] font-thin flex justify-center items-center">
            CONTACT
